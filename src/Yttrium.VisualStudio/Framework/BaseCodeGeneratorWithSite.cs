...
namespace CustomToolGenerator
{
    ...
    [
        ...
        Guid( "347d368f-20d5-444e-af5b-856d031cdd89" ),
        ComVisible( true )
    ]
    public abstract class BaseCodeGeneratorWithSite : BaseCodeGenerator, IObjectWithSite
    {
        ...
        [
            ...
            SuppressMessage( "Microsoft.Globalization", "CA1303:DoNotPassLiteralsAsLocalizedParameters", MessageId = "System.Runtime.InteropServices.COMException.#ctor(System.String,System.Int32)" ),
        ...
        protected void AddReferenceDllToProject( string[] referenceDll )
        {
            ...
            {
                string errorMessage = String.Format( CultureInfo.InvariantCulture, "Unable to add DLL to project references: {0}.  Please Add them manually.", GetDllNames( referenceDll ) );
        ...
        protected virtual void GenerateVersionComment( System.CodeDom.CodeNamespace codeNamespace )
        {
            ...
            codeNamespace.Comments.Add( new CodeCommentStatement( String.Format( CultureInfo.InvariantCulture, "This source code was auto-generated by {0}, Version {1}.",
